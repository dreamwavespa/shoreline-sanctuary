...
export const QUESTS: QuestDef[] = [
  ...
  {
    id: "sandystormhunt",
    title: "Sandy's Post-Storm Hunt",
    from: "Sandy the Sandpiper",
    letter: "The storm last night churned up all sorts of treasures — and trouble! Could you clear a plastic ring from the tide pools and gather a few pieces of blue sea glass while the sand is still soft? Zero stress, I promise — just a nice little scavenger hunt.",
    requires: [
      { itemId: "trash-plastic", count: 1 },
      { itemId: "glass-blue", count: 3 },
    ],
    rewardItemId: "blueprint-wind-chime",
    rewardCount: 1,
    rewardLabel: "Frosted Glass Wind Chime Blueprint",
    phase: 1,
  },
  {
    id: "sunnyshellpalette",
    title: "Sunny's Shell Palette",
    from: "Sunny the Starfish",
    letter: "I've been dreaming up a new shell-painting pattern, but I'm all out of scallop shells to practice on! If you bring me a few from the Tide Pools, I'll teach you a lovely pastel wave design.",
  ...
  {
    id: "minapartybaking",
    title: "Mina's Party Baking",
    from: "Mina the Manatee",
    letter: "I'm hosting a little celebration down in the Underwater Village and I need fresh sea berries from the Dunes for my kelp cookies! Could you harvest a few for me? I'll bake you a batch to keep.",
    requires: [{ itemId: "sea-berry", count: 3 }],
    rewardItemId: "food-kelp-cookie",
    rewardCount: 2,
    rewardLabel: "2x Warm Kelp Cookies (+Movement Speed)",
    phase: 2,
  },
  {
    id: "kaiburrowsecret",
    title: "Kai's Burrow Secret",
    from: "Kai the Clam",
    letter: "Pfft-squirt! I've buried something special on North Beach, but I only trade with friends who bring me a shiny soda tab. Find my little squirt of water in the sand and see what I'm hiding.",
    requires: [{ itemId: "shiny-soda-tab", count: 1 }],
    rewardItemId: "shell-opal-rare",
    rewardCount: 1,
    rewardLabel: "1x Rare Opal Shell (Notebook Entry)",
    phase: 2,
  },
  {
    id: "kaianasunkenrelic",
    title: "Kaiana's Sunken Relic",
    from: "Kaiana, Master Restorer",
    letter: "There's a tarnished brass compass resting in the old shipwreck — I can feel it calling to be restored. If you can retrieve it for me, I promise to bring it back to its former glory, and it will still point the way home.",
    requires: [{ itemId: "tarnished-compass", count: 1 }],
    rewardItemId: "display-mariners-compass",
    rewardCount: 1,
    rewardLabel: "Restored Mariner's Compass Display Item",
    phase: 3,
  },
];
