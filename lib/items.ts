...
export const ITEMS: Record<string, ItemDef> = {
  ...
  "kelp": { id: "kelp", name: "Kelp", category: "raw", icon: "🌿", isEmoji: true, rarity: "common", sfx: "driftwood" },
  ...
  "kelp-resin": { id: "kelp-resin", name: "Kelp Resin", category: "raw", icon: "🟩", isEmoji: true, rarity: "uncommon", sfx: "driftwood" },
  "pure-water": { id: "pure-water", name: "Pure Water Vial", category: "special", icon: "💧", isEmoji: true, rarity: "uncommon", sfx: "seaGlass" },
