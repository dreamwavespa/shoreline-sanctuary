...
export const VILLAGERS: Record<string, VillagerDef> = {
  ...
  boo: {
    ...
    group: "shoreline-resident",
    personality: "Playfully spooky, precise with color, and happiest beneath the moon.",
    role: "Sand Art Assistant & October Guide",
    behavior: "Runs a tiny bottle stall from driftwood on the Shifting Sandbars.",
    gameplay: "Once the player crafts and delivers his recycled tool set, Boo co-hosts custom sand art with Kaiana and shares one daily bundle of rare Pumpkin Orange or Candy Corn Swirl sand during October.",
    schedule: "At his Sandbar stall year-round; rare colors are available October 1–31.",
    location: "Shifting Sandbars",
    imageUrl: "/images/boo-sand-art.jpeg",
    gift: {
      lovedGiftIds: ["dried-sugar-berries", "sealed-frosted-bottle"],
      reactionSfx: "Soft sand pour and happy claw taps",
      reactionVisual: "Orange and white sand spirals",
      redirectTo: ["kaiana"],
    },
  },
  penelope: {
