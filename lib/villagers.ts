...
export const VILLAGERS: Record<string, VillagerDef> = {
  ...
  boo: {
    ...
    gameplay: "Co-hosts custom sand art with Kaiana and shares one daily bundle of rare Pumpkin Orange or Candy Corn Swirl sand during October.",
    ...
    gift: {
      lovedGiftIds: ["sand-pumpkin-orange", "sand-candy-corn-swirl", "shell-cowrie"],
