...
export const NOTEBOOK_SECTIONS: NotebookSection[] = [
  {
    ...
    entries: [
      ...
      { id: "tarnished-compass", kind: "item", note: "Bought from Seaweed or pulled from the old shipwreck, waiting to be restored." },
      ...
      { id: "magnifying-glass", kind: "item", note: "A brass-handled lens found while searching the Hidden Cove chest." },
  ...
  },
  {
    ...
    entries: [
      ...
      { id: "sand-snow-white", kind: "item", note: "Pure white island sand found along the shore and across the shifting sandbars." },
