// Centralized hosted-media URLs. Most media here is externally hosted.
// New locally stored SFX can live in /public/audio and are referenced
// with paths beginning with /audio/.
...
export const SFX_FILES: Record<string, string> = {
  ...
  // Local notebook page-turn sound:
  // public/audio/Notebook page.wav
